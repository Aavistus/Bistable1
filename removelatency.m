...
% Check if the latency between two consecutive markers (numl or back) is less
% than 1250 (i.e. 2500 ms). If yes, rename to 'ignore'.
...
% Calculate frequency of numl and back, and the difference.    
...
save([filepath subject 'count.mat'],'nronuml', 'nroback','diff');      
